...
body {
  ...
  background-image: radial-gradient(circle at top left, rgba(148, 163, 184, 0.08), transparent 18%),
...
.login-page {
  background: radial-gradient(circle at top, rgba(255, 255, 255, 0.08), transparent 20%),
